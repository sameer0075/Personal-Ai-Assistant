import { e as editor, U as Uri, a as MarkerTag, M as MarkerSeverity, l as languages, t as typescriptDefaults, R as Range } from "./index-G351ExLb.js";
      ...
      this._client = (async () => {
        this._worker = createWebWorker({
          ...
          createWorker: () => new Worker(new URL(
            /* @vite-ignore */
            "" + new URL("ts.worker-B_w3UDAD.js", import.meta.url).href,
            import.meta.url
          ), { type: "module" }),
          label: this._modeId,
          keepIdleModels: true,
