    ...
    if (!this._client) {
      this._worker = createWebWorker({
        ...
        createWorker: () => new Worker(new URL(
          /* @vite-ignore */
          "" + new URL("css.worker-D_2p-Q7z.js", import.meta.url).href,
          import.meta.url
        ), { type: "module" }),
