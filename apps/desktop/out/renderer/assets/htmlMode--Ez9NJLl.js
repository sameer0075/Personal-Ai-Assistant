...
import { H as HoverAdapter, D as DocumentHighlightAdapter, h as DocumentLinkAdapter, F as FoldingRangeAdapter, b as DocumentSymbolAdapter, S as SelectionRangeAdapter, c as RenameAdapter, f as DocumentFormattingEditProvider, g as DocumentRangeFormattingEditProvider, C as CompletionAdapter } from "./lspLanguageFeatures-BKT6-30d.js";
import { a, e, d, R, i, j, t, k } from "./lspLanguageFeatures-BKT6-30d.js";
import { l as languages } from "./index-G351ExLb.js";
    ...
    if (!this._client) {
      this._worker = createWebWorker({
        ...
        createWorker: () => new Worker(new URL(
          /* @vite-ignore */
          "" + new URL("html.worker-1zZHDAzE.js", import.meta.url).href,
          import.meta.url
        ), { type: "module" }),
