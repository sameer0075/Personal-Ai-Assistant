...
const SYSTEM_PROMPT = [
  ...
  "",
  "Plan before acting: for anything about the user's background, past emails, schedule, or prior posts,",
  "search the knowledge base first. For anything requiring CURRENT inbox, calendar, or LinkedIn state,",
  "call the relevant tool directly rather than guessing. When asked to write and send an email, create an",
